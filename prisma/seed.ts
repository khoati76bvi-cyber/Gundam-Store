...
// Khởi tạo trống hoàn toàn để không bao giờ bị lỗi kiểm duyệt cấu trúc object
...
async function main() {
  ...
  await prisma.setting.createMany({
    data: [{ key: 'storeName', value: 'GundamStore Vietnam' }, { key: 'hotline', value: '0909 000 000' }, { key: 'shippingFee', value: '30000' },
  ...
  await prisma.searchInsight.createMany({
    data: [
